...
conf = {
    ...
    "save_path": "Gcnn_v1_test/version_1/",
    "output_path":"Gcnn_v1_output/version_1/",
    # "word_emb_init": "./data/word_embedding.pkl",
    "init_model": "Gcnn_v1_model/version_1/",  # should be set for test
    "embedding_file": "../../douban/ubuntu/word_embedding.pkl",
    "CPU":"/cpu:0", #'/gpu:1'
    "emb_train":False,
        ...
        def conv1d_weightnorm(inputs, layer_idx, out_dim, kernel_size, padding="SAME", dropout=1.0,
            ...
            with tf.variable_scope(var_scope_name, reuse=reuse):
               ...
               # inputs_look=inputs #有值
                ...
                #inputs =tf.nn.conv1d(value=inputs, filters=V, stride=1, padding=padding)
