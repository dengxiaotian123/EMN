...
conf = {
    ...
    "save_path": "Gcnn_v4_test/version/",
    "output_path":"Gcnn_v4_output/version/",
    # "word_emb_init": "./data/word_embedding.pkl",
    "init_model": "Gcnn_v4_model/version/",  # should be set for test
...
class MyModel(object):
   ...
   # def BuildModel(self):
       ...
       # input_hyp = emb(self.hypothesis_x, mask_hyp)  #response_embeddings
        ...
        self.matching_vectors = matching_vectors #[64 10 50]
