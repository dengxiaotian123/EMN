...
conf = {
    ...
    "save_path": "Gcnn_v11_test/version_1/",
    "output_path":"Gcnn_v11_output/version_1/",
    # "word_emb_init": "./data/word_embedding.pkl",
    "init_model": "Gcnn_v11_model/version_1/",  # should be set for test
     ...
     #   A_matrix = tf.get_variable('A_matrix_v', shape=( self.dim ,  self.dim ),
      ...
      #  B_matrix = tf.get_variable('B_matrix_v', shape=(self.dim*4, self.dim*4),
       ...
       #                                  kwidths_list=[3] * conf["word_layers_itg"], dropout_dict=dropout_dict,
        ...
        self.conv2_itg, _ = tf.nn.dynamic_rnn(final_GRU, tf.stack(matching_vectors, axis=0, name='matching_stack'),
                                                dtype=tf.float32,
