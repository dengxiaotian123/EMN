...
conf = {
    ...
    "save_path": "Gcnn_test/version_2",
    "output_path":"Gcnn_output/version_2",
    # "word_emb_init": "./data/word_embedding.pkl",
    "init_model": "Gcnn_model/version_2",  # should be set for test
 ...
 #               inputs=tf.nn.conv1d(value=inputs, filters=V, stride=1, padding=padding) # [64 50 900] #-inf
       ...
       # input_hyp = emb(self.hypothesis_x, mask_hyp)  #response_embeddings
        ...
        # hypothesis_attns:[64 50 200]
          ...
          #  print(m_a.shape)
            matrix2 = tf.einsum('aij,jk->aik', m_a, A_matrix)  # TODO:check this #A_matrix[800 800]
            matrix2 = tf.matmul(matrix2, tf.transpose(m_b,perm=[0,2,1]))
