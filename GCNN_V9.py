...
conf = {
    ...
    "save_path": "Gcnn_v9_test/version_1/",
    "output_path":"Gcnn_v9_output/version_1/",
    # "word_emb_init": "./data/word_embedding.pkl",
    "init_model": "Gcnn_v9_model/version_1/",  # should be set for test
    ...
    def __init__(self, conf):
     ...
     #   self.keep_prob = tf.placeholder(tf.float32)
       ...
       # input_hyp = emb(self.hypothesis_x, mask_hyp)  #response_embeddings
        ...
        # hypothesis_attns:[64 50 200]
          ...
          #  print('hypothesis_attns:', response_attns.get_shape().as_list())  # [None, hyp_len, 600]
            ...
            matrix = tf.stack([matrix1, matrix2], axis=3, name='matrix_stack') #[64 50 50 2]
        ...
        self.b = tf.stack(matching_vectors, axis=1, name='matching_stack')  # [10 80 50]
        self.conv2_itg = conv_encoder_stack(self.b, nhids_list=[100] * conf["word_layers_itg"],
      ...
      #  conv_2 = tf.nn.dropout(conv_2, keep_prob=self.keep_prob)
        self.logits = tf.contrib.layers.fully_connected(inputs=conv_2, num_outputs=2, activation_fn=None,
