...
#    with open(file_path, 'r') as infile:
    for i in range(len(scores)):
        if i % 10 == 0:
            data = []
        data.append((float(scores[i]), int(labels[i])))
        ...
        i += 1
    ma=1.0*sum_m_a_p/total_num
    mrr=1.0*sum_m_r_r/total_num
    p1=1.0*sum_p_1/total_num
    R10_1=1.0*sum_r_1/total_num
    R10_2=1.0*sum_r_2/total_num
    R10_5=1.0*sum_r_5/total_num
    ...
    print('R10_2',R10_2)
    print('R10_5',R10_5)
    print('ave:',(ma+mrr+p1+R10_1+R10_2+R10_5)/6)
