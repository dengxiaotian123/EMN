...
conf = {
    ...
    "save_path": "Gcnn_v3_test/version2/",
    "output_path":"Gcnn_v3_output/version2/",
    "init_model": "Gcnn_v3_model/version2/",  # should be set for test
   ...
   # def BuildModel(self):
     ...
     #   start=time.time
       ...
       # input_hyp = emb(self.hypothesis_x, mask_hyp)  #response_embeddings
        ...
        self.conv2_itg = conv_encoder_stack(self.b, nhids_list=[75] * conf["word_layers_itg"],
        ...
        with tf.Session() as sess:
            ...
            for step_i in xrange(conf["epoch"]):
                ...
                for batch_index in range(batch_num):
                  ...
                  #  self.b=
                  #  matching_vectors = sess.run(self.matching_vectors, feed_dict=feed_dict)
                  #  print('matching_vectors', matching_vectors)
                  #  input_shape = sess.run(self.input_shape,feed_dict=feed_dict)
