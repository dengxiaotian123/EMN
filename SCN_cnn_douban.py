...
conf = {
    ...
    "save_path": "cnn_test/douban",
    "output_path":"output/douban",
    # "word_emb_init": "./data/word_embedding.pkl",
    "init_model": "model/douban",  # should be set for test
...
class SCN():
    def __init__(self,conf):
       # self._graph = tf.Graph()
        ...
        self.rnn_units = 200
        self.total_words = 172131 #434513  172131#douban 172131
    ...
    def BuildModel(self):
       # with self._graph.as_default():
        ...
        #utterance_embeddings 10个[40 50 200],utterance_len 10个[40]
            ...
            self.utterance_GRU_embeddings=utterance_GRU_embeddings
        ...
        b=tf.stack(matching_vectors, axis=0, name='matching_stack')#[10 80 50]
        print('b',b.get_shape().as_list()) #
        _, self.last_hidden = tf.nn.dynamic_rnn(final_GRU, tf.stack(matching_vectors, axis=0, name='matching_stack'), dtype=tf.float32,
                                           time_major=True, scope='final_GRU')  # TODO: check time_major
       #last_hidden:[80 200]
       # a=last_hidden.get_shape().as_list()
       # print(a)
    ...
    def TestModel(self,conf):
        ...
        with tf.Session() as sess:
            ...
            # with tf.Session() as sess:
            # sess.run(init)
            saver.restore(sess,os.path.join(conf["init_model"],"model.5" ))
