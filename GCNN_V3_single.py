...
conf = {
    ...
    "save_path": "Gcnn_v3_single_test/version/",
    "output_path":"Gcnn_v3_single_output/version/",
    # "word_emb_init": "./data/word_embedding.pkl",
    "init_model": "Gcnn_v3_single_model/version/",  # should be set for test
...
class MyModel(object):
    ...
    ## Functions
     ...
     #   start=time.time
        ...
        utterance_embeddings = tf.nn.embedding_lookup(word_embeddings, self.utterance_ph)  # [64 10 50 200]
        ...
        v1_bi = infer_utter * mask_utter  # mask: (64, 200, 1) #padding 的地方归零v1_bi [64 50 300]
        ...
        with tf.Session() as sess:
            ...
            for step_i in xrange(conf["epoch"]):
                ...
                for batch_index in range(batch_num):
                    ...
                    m_a=sess.run(self.m_a, feed_dict=feed_dict)
                    print(m_a.shape)
                    print(m_a)
                    exit(1)
                   # m_a,_, summary = sess.run([self.m_a,self.train_op, merged], feed_dict=feed_dict)
